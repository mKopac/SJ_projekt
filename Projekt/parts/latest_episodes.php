            ...
            <div class="col-lg-6 col-12 mb-4 mb-lg-0">
                <div class="custom-block d-flex">
                    ...
                    <div class="custom-block-info">
                        ...
                        <p class="mb-0">In the closing days of the Korean War, the staff of the 4077 MASH Unit find
                            themselves facing irrevocable changes in their lives.</p>
            ...
            <div class="col-lg-6 col-12 mb-4 mb-lg-0">
                <div class="custom-block d-flex">
                    ...
                    <div class="custom-block-info">
                        ...
                        <p class="mb-0">Margaret seeks contributions for a time capsule.</p>
